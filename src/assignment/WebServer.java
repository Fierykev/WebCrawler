...
public class WebServer {
    ...
    public static void main(String[] args) throws Exception {
        WebQueryEngine wqe = WebQueryEngine
                .fromIndex((WebIndex) Index.load("index.db"));
    ...
    private class HttpRequest {
        ...
        HttpRequest(String u, String m, HashMap<String, String> h,
            ...
            if (cmd.length < 3) {
                ...
                if (cmd[0].equals("GET") || cmd[0].equals("HEAD")) {
                    ...
                    if (idx < 0) {
                        ...
                        url = URLDecoder.decode(cmd[1].substring(0, idx),
                                "ISO-8859-1");
                        ...
                        for (String param : prms) {
                            ...
                            if (temp.length == 2) {
                                params.put(
                                        URLDecoder.decode(temp[0],
                                                "ISO-8859-1"),
                                        URLDecoder.decode(temp[1],
                                                "ISO-8859-1"));
                            } else
                                if (temp.length == 1 && param
                                        .indexOf('=') == param.length() - 1) {
