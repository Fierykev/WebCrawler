...
public class TestPatternURLGen {
    ...
    public void createRandomWebsite() {
        ...
        while (!newPages.isEmpty()) {
            ...
            int bodyUrlBound = r.nextInt(numBodies);

            // for pages that are divisible by three
            String insertDivThree = (pageName % 3 == 0) ? "divthree" : "notdiv";

            // for pages that are divisible by two
            String insertDivTwo = (pageName % 2 == 0) ? "divtwo" : "notdiv2";

            // for pages that are divisible by seven
            String insertDivSeven = (pageName % 7 == 0)
                    ? "le phrase query"
                    : "nope query please";

            for (int i = 0; i < numBodies; i++) {
                // add the text
                body += "<p class=MsoNormal>" + createText(false) + " "
                        + insertDivTwo + " " + createText(false) + " "
                        + insertDivThree + " " + createText(false) + " "
                        + insertDivSeven + " " + createText(false) + "</p>";

                // add in an image with random text
                body += "<img src=\"blahblahcardgamesblahblah.jpg\" alt=\"no image\" title=\""
                        + createText(true) + "\">";
